...
class TimeseriesTransformer():
    def __init__(self, 
                 scale=True, scale_mean=0, scale_std=1,
                 timeenc=1, freq='h', 
                 date_start=0, date_scale=1):
        self.scale = scale
        ...
        if self.scale:
            ...
            self.scaler.mean_ = np.array([scale_mean])
    ...
    def fit_transform(self, input):
        ...
        df_stamp = df[['date']]
        df_stamp['date'] = self.date_start + self.date_scale * df_stamp['date']
